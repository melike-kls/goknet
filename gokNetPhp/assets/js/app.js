...
function toggleFileInput(isStudent) {
  var fileUploadSection = document.getElementById("fileUploadSection");
  var fileInput = document.getElementById("inputGroupFileStudent");
...
function toggleMomInputs(isAlive) {
  var momInputs = document.querySelectorAll('#momJob, #momNumber, #momMail');
  momInputs.forEach(function (input) {
      input.disabled = !isAlive;
  });
}

function toggleDadInputs(isAlive) {
  var dadInputs = document.querySelectorAll('#dadJob, #dadNumber, #dadMail');
  dadInputs.forEach(function (input) {
      input.disabled = !isAlive;
  });
}
